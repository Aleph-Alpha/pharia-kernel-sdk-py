...
@dataclass
class CompletionEvent_Delta:
    value: CompletionDelta


@dataclass
class CompletionEvent_Finished:
    value: FinishReason
...
CompletionEvent = Union[CompletionEvent_Delta, CompletionEvent_Finished, CompletionEvent_Usage]
"""
...
@dataclass
class ChatEvent_MessageStart:
    value: str


@dataclass
class ChatEvent_MessageDelta:
    value: MessageDelta
...
ChatEvent = Union[ChatEvent_MessageStart, ChatEvent_MessageDelta, ChatEvent_MessageEnd, ChatEvent_Usage]
"""
