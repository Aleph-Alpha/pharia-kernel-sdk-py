...
When Skills are run in the Engine, the CSI is provided via an Application Binary Interface.
...
The CSI which is available to the Skill at runtime can be substituted with a DevCSI which is backed by HTTP requests against a running instance of the Engine.
